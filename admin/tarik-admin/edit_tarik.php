<?php
    ...
    if(isset($_GET['kode'])){
        $sql_cek = "SELECT * FROM 
		tb_tarik WHERE id_transaksi='".$_GET['kode']."'";
...
<div class="card card-success">
	...
	<form action="" method="post" enctype="multipart/form-data">
		...
		<div class="card-footer">
			...
			<a href="?page=tarik-admin" title="Kembali" class="btn btn-secondary">Batal</a>
		</div>
	</form>
</div>
...
<?php
    ...
    if ($query_ubah) {
      ...
      Swal.fire({title: 'Transaksi Berhasil di Proses',text: '',icon: 'success',confirmButtonText: 'OK'
        ...
        {window.location = 'index.php?page=tarik-admin';
        }
      })</script>";
      }else{
      echo "<script>
