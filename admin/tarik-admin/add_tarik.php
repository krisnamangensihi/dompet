...
<div class="card card-primary">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-edit"></i> Setor Tunai</h3>
	</div>
...
<div class="col-sm-6">
       <input name="fee" type="text" required class="form-control" id="harga_jual" autocomplete="off" onkeyup="convertToRupiah(this);" value="15000" readonly="readonly">
...
<div class="col-sm-6">
                   <input name="jumlah" type="text" required class="form-control" id="harga_jual" autocomplete="off" onkeyup="convertToRupiah(this);" value="03567887908" readonly="readonly">
                   </div>
      </div>
                <div class="form-group row">
