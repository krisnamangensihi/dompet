...
<div class="card card-primary">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-edit"></i> Transfer Tunai</h3>
	</div>
	<form action="" method="post" enctype="multipart/form-data">
     <?php  
              // fungsi untuk membuat id transaksi
             $query = "SELECT RIGHT(id_transaksi,6) as kode FROM tb_tunai
...
<div class="col-sm-6">
		...
		<div class="card-footer">
			...
			<a href="?page=data-tunai" title="Kembali" class="btn btn-secondary">Batal</a>
		</div>
	</form>
</div>
...
$total    =$jumlah+$fee;
 ...
 $sql_simpan = "INSERT INTO tb_tunai(id_transaksi,rek,jumlah,fee,total,keterangan,status,id_user) VALUES (
			'".$_POST['id']."', 
			'".$_POST['rek']."', 
      ...
      Swal.fire({title: 'Setor Tunai Sedang Diproses',text: '',icon: 'success',confirmButtonText: 'OK'
          ...
          window.location = 'index.php?page=data-tunai';
          }
      })</script>";
      }else{
      echo "<script>
      Swal.fire({title: 'Tambah Data Gagal',text: '',icon: 'error',confirmButtonText: 'OK'
          ...
          window.location = 'index.php?page=add-tunai';
          }
      })</script>";
    }}