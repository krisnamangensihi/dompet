...
<div class="card card-primary">
	...
	<form action="" method="post" enctype="multipart/form-data">
     <?php  
             ...
             $query = "SELECT RIGHT(id_transaksi,6) as kode FROM tb_kirim
...
<div class="col-sm-6">
                   <input name="penerima" type="text" required class="form-control" id="nama" autocomplete="off" >
                   </div>
      </div>
      <div class="form-group row">
...
<div class="col-sm-6">
                   <input name="alamat" type="text" required class="form-control" id="alamat" autocomplete="off" >
                   </div>
      </div>
      
              <div class="form-group row">
                <label class="col-sm-2 control-label">Jumlah Kiriman</label>
...
<div class="col-sm-6">
		...
		<div class="card-footer">
			...
			<a href="?page=data-kirim" title="Kembali" class="btn btn-secondary">Batal</a>
		</div>
	</form>
</div>
...
error_reporting(0);
 ...
 $sql_simpan = "INSERT INTO tb_kirim(id_transaksi,penerima,alamat,jumlah,fee,total,keterangan,status,id_user) VALUES (
			'".$_POST['id']."', 
			'".$_POST['penerima']."', 
			'".$_POST['alamat']."', 
      ...
      Swal.fire({title: 'Transaksi Sedang Diproses',text: '',icon: 'success',confirmButtonText: 'OK'
          ...
          window.location = 'index.php?page=data-kirim';
          }
      })</script>";
      }else{
      echo "<script>
      Swal.fire({title: 'Tambah Data Gagal',text: '',icon: 'error',confirmButtonText: 'OK'
          ...
          window.location = 'index.php?page=add-kirim';
          }
      })</script>";
    }}