...
<div class="card card-info">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-table"></i> Data Transfer Antar Bank</h3>
	</div>
	<!-- /.card-header -->
	<div class="card-body">
		<div class="table-responsive">
			<div>
				<a href="?page=add-antar" class="btn btn-primary">
					<i class="fa fa-edit"></i> Transfer Antar Bank</a>
			</div>
			<br>
