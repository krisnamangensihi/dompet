...
<div class="form-group row">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" name="pencipta" autocomplete="off" onkeyup="convertToRupiah(this);" required>
                </div>
              </div>
 <div class="form-group row">
                <label class="col-sm-2 control-label">RBT</label>
                <div class="col-sm-6">
                  <input type="text" class="form-control" id="harga_beli" name="arranger" autocomplete="off" onkeyup="convertToRupiah(this);" required>
                </div>
              </div>
            <div class="form-group row">
                <label class="col-sm-2 control-label">Pajak</label>
                <div class="col-sm-6">
                  <input type="text" class="form-control" name="pajak" autocomplete="off" onkeyup="convertToRupiah(this);" required>
                </div>
              </div>
<div class="form-group row">
                <label class="col-sm-2 control-label">Jumlah Konsul</label>
                <div class="col-sm-6">
                  <input type="text" class="form-control" name="status" autocomplete="off" onkeyup="convertToRupiah(this);" required>
                </div>
              </div>
 <div class="form-group row">
                <label class="col-sm-2 control-label">Bagi Hasil</label>
                <div class="col-sm-6">
                   <input type="text" class="form-control" name="tgl" autocomplete="off" onkeyup="convertToRupiah(this);" required>
                </div>
              </div>
               <div class="form-group row">
...
$koneksi = new mysqli ("localhost","root","zainuri123","db_bd");
 ...
 $sql_simpan = "INSERT INTO tb_rincian(id_penjualan,periode,sumber,konten,rbt,pajak,jumlah,bagi_hasil,id_user,pdf) VALUES (
			...
			'".$_POST['periode']."',
			'".$_POST['judul_rincian']."',
			'".str_replace('.', '',($_POST['pencipta']))."',
			'".str_replace('.', '',($_POST['arranger']))."',
			'".str_replace('.', '',($_POST['pajak']))."',
			'".str_replace('.', '',($_POST['status']))."',
