...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">
            <i class="fa fa-edit"></i> Setor Tunai
        </h3>
    </div>
    <form action="" method="post" enctype="multipart/form-data">
        <?php  
              // fungsi untuk membuat id transaksi
             $query = "SELECT RIGHT(id_transaksi,6) as kode FROM tb_setor
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="id" value="<?php echo  $kode_transaksi; ?>" readonly
                        required>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="harga_jual" name="jumlah" autocomplete="off"
...
<?php
 ...
 $sql_simpan = "INSERT INTO tb_setor(id_transaksi,jumlah,keterangan,status,id_user) VALUES (
			'".$_POST['id']."', 
      ...
      Swal.fire({title: 'Setor Tunai Sedang Diproses',text: '',icon: 'success',confirmButtonText: 'OK'
          ...
          window.location = 'index.php?page=data-setor';
          }
      })</script>";
      }else{
      echo "<script>
      Swal.fire({title: 'Tambah Data Gagal',text: '',icon: 'error',confirmButtonText: 'OK'
          ...
          window.location = 'index.php?page=add-setor';
          }
      })</script>";
    }}