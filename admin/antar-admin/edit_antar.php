<?php
    ...
    if(isset($_GET['kode'])){
        $sql_cek = "SELECT * FROM 
		tb_antar WHERE id_transaksi='".$_GET['kode']."'";
		...
		<div class="card-body">
          ...
          <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                   <input name="rek" type="text" required class="form-control" id="harga_jual" autocomplete="off" value="<?php echo $data['bank']; ?>" readonly>
                </div>
              </div>
               <div class="form-group row">
...
<?php
    ...
    if ($query_ubah) {
      ...
      Swal.fire({title: 'Transaksi Berhasil di Proses',text: '',icon: 'success',confirmButtonText: 'OK'
        ...
        {window.location = 'index.php?page=antar-admin';
        }
      })</script>";
      }else{
      echo "<script>
